    ...
    <div class="archivio-wrap">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:40px;max-width:800px;margin-top:8px">
        ...
        <div>
          ...
          <p style="font-family:'Playfair Display',serif;font-size:1rem;line-height:1.8;color:var(--ink);opacity:0.75;margin-bottom:16px">Scrivi, fotografi, disegni, viaggi? Geo-POPlitica è un progetto collettivo, parlaci di te, facci sapere cosa ti piacerebbe realizzare e mostraci qualcosa di quello che fai tramite un link al tuo sito, blog o account social pubblico (non usare allegati). Collaboriamo per passione e non per compenso, ma ci teniamo a farlo bene. Siamo alla ricerca di persone curiose da ogni angolo del mondo.</p>

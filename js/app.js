...
function renderChiSiamo() {
  ...
  <div style="max-width:720px;font-family:'Playfair Display',serif;font-size:1.05rem;line-height:1.9;color:var(--ink)">
    ...
    <p style="margin-bottom:20px">Siamo informati, aggiornati, accerchiati da dati e notizie. Abitiamo l'ambiguità dei tempi e le contraddizioni del nostro essere umani, così ci ritroviamo in interminabili discussioni sulle sorti del mondo. Alla fine, esausti, ce ne torniamo a casa, ben sapendo che non risparmieremo critiche nemmeno a noi stessi.</p>
